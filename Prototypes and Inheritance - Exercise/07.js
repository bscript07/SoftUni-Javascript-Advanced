function solve() {
  ...
  class Battery extends Device {
    ...
    set expectedLife(value) {
      if (typeof value !== "number")
        throw new TypeError("ExpectedLife must be a valid number!");
  ...
  class Keyboard extends Device {
    ...
    set responseTime(value) {
      if (typeof value !== "number")
        throw new TypeError("ResponseTime must be a valid number!");
  ...
  class Computer extends Device {
    ...
    set processorSpeed(value) {
      if (typeof value !== "number")
        throw new TypeError("ProcessorSpeed must be a valid number!");
    ...
    set ram(value) {
      if (typeof value !== "number")
        throw new TypeError("RAM must be a valid number!");
      this._ram = value;
    }
    ...
    set hardDiskSpace(value) {
      if (typeof value !== "number")
        throw new TypeError("HardDiskSpace must be a valid number!");
  ...
  class Laptop extends Computer {
    ...
    set color(value) {
      if (typeof value !== "string")
        throw new TypeError("Width must be a valid string!");
      this._color = value;
    }
